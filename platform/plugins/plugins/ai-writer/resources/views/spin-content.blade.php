    ...
    <div class="row">
        <div class="col-md-4 col-sm-6">
            <div class="form-group mb-3">
                ...
                <div class="ui-select-wrapper">
                    {{ Form::select('target_spin_field', ['description', 'content'], 'content', ['class' => 'ui-select']) }}
        ...
        <div class="col-md-12 col-sm-6">
            <div class="form-group mb-3 preview-wrapper-content">
                {{ Form::editor('preview_content', null, ['placeholder' => trans('plugins/ai-writer::ai-writer.form.preview_placeholder'), 'id' => 'preview_spin_content']) }}
            </div>
        </div>
    </div>
</form>
