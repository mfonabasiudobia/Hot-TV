...
use Botble\Stream\Repositories\Interfaces\PlanInterface;
...
// if (! function_exists('get_Plan_page_id')) {
//     function get_Plan_page_id(): string|null
//     {
//         return theme_option('Plan_page_id', setting('Plan_page_id'));
//     }
// }

// if (! function_exists('get_Plan_page_url')) {
//     function get_Plan_page_url(): string
//     {
//         $PlanPageId = (int)theme_option('Plan_page_id', setting('Plan_page_id'));

//         if (! $PlanPageId) {
//             return route('public.index');
//         }

//         $PlanPage = app(PageInterface::class)->findById($PlanPageId);
