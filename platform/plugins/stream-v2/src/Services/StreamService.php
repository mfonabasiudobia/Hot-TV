...
namespace Botble\Stream\Services;

use Botble\Base\Enums\BaseStatusEnum;
use Botble\Base\Supports\Helper;
use Botble\Stream\Models\Category;
use Botble\Stream\Models\Post;
use Botble\Stream\Models\Tag;
use Botble\Stream\Repositories\Interfaces\CategoryInterface;
use Botble\Stream\Repositories\Interfaces\PostInterface;
    ...
    public function handleFrontRoutes(Slug|array $slug): Slug|array|Builder
    {
        ...
        switch ($slug->reference_type) {
            case Post::class:
                ...
                if (function_exists('admin_bar')) {
                    AdminBar::registerLink(
                        trans('plugins/Stream::posts.edit_this_post'),
                ...
                return [
                    'view' => 'post',
                    'default_view' => 'plugins/Stream::themes.post',
                    'data' => compact('post'),
                    'slug' => $post->slug,
                ];
            case Category::class:
                ...
                if (function_exists('admin_bar')) {
                    AdminBar::registerLink(
                        trans('plugins/Stream::categories.edit_this_category'),
                ...
                return [
                    'view' => 'category',
                    'default_view' => 'plugins/Stream::themes.category',
            ...
            case Tag::class:
                ...
                if (function_exists('admin_bar')) {
                    AdminBar::registerLink(
                        trans('plugins/Stream::tags.edit_this_tag'),
                ...
                return [
                    'view' => 'tag',
                    'default_view' => 'plugins/Stream::themes.tag',
