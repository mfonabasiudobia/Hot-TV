...
interface StreamInterface extends RepositoryInterface
{
    ...
    // public function getAllStream(int $perPage = 12, bool $active = true, array $with = ['slugable']): Collection|LengthAwarePaginator;
