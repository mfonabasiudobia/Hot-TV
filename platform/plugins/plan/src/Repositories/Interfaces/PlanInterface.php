...
namespace Botble\Plan\Repositories\Interfaces;
...
interface PlanInterface extends RepositoryInterface
{
    ...
    // public function getAllPlan(int $perPage = 12, bool $active = true, array $with = ['slugable']): Collection|LengthAwarePaginator;
