...
namespace Botble\Plan\Services;
    ...
    public function handleFrontRoutes(Slug|array $slug): Slug|array|Builder
    {
        ...
        switch ($slug->reference_type) {
            case Post::class:
                ...
                if (function_exists('admin_bar')) {
                    AdminBar::registerLink(
                        trans('plugins/Plan::posts.edit_this_post'),
                ...
                return [
                    'view' => 'post',
                    'default_view' => 'plugins/Plan::themes.post',
                    'data' => compact('post'),
                    'slug' => $post->slug,
                ];
            case Category::class:
                ...
                if (function_exists('admin_bar')) {
                    AdminBar::registerLink(
                        trans('plugins/Plan::categories.edit_this_category'),
                ...
                return [
                    'view' => 'category',
                    'default_view' => 'plugins/Plan::themes.category',
            ...
            case Tag::class:
                ...
                if (function_exists('admin_bar')) {
                    AdminBar::registerLink(
                        trans('plugins/Plan::tags.edit_this_tag'),
                ...
                return [
                    'view' => 'tag',
                    'default_view' => 'plugins/Plan::themes.tag',
