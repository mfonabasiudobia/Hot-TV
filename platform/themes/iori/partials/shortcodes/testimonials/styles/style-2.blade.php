        ...
        <div class="row align-items-start">
            <div class="col-lg-4 text-start pt-50">
                ...
                @if ($title = $shortcode->title)
                    <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">{{ $title }}</h2>
                @endif

                @if ($subtitle = $shortcode->subtitle)
                    <p class="font-lg color-gray-500 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">{{ $subtitle }}</p>
                @endif
            </div>
            <div class="col-lg-8">
                <div class="row">
