        ...
        <div class="row align-items-center">
            <div class="col-lg-12 text-center mb-40">
                @if ($title = $shortcode->title)
                    <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".s">{{ $title }}</h2>
                @endif

                @if ($subtitle = $shortcode->subtitle)
                    <p class="font-lg color-gray-500 wow animate__animated animate__fadeIn" data-wow-delay=".2s">{{ $subtitle }}</p>
                @endif
            </div>
        </div>
        <div class="row align-items-start" data-masonry="{&quot;percentPosition&quot;: true }">
            @foreach($testimonials as $testimonial)
                ...
                <div class="card-testimonial-grid">
                    ...
                    <p class="font-md color-grey-500">{{ $testimonial->content }}</p>
