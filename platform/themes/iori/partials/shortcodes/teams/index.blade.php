        ...
        <div class="row align-items-start">
            <div class="col-lg-6">
                @if ($subtitle = $shortcode->subtitle)
                    <h6 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s">{{ $subtitle }}</h6>
                @endif

                @if ($title = $shortcode->title)
                    <h2 class="color-brand-1 mb-50 wow animate__animated animate__fadeIn" data-wow-delay=".2s">{{ $title }}</h2>
                @endif
            </div>
        </div>
        <div class="row align-items-start">
            @foreach($teams as $team)
                <div class="col-lg-3 col-md-4 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".{{ $loop->iteration * 2 }}s">
