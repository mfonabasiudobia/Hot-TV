        ...
        <div class="row align-items-center">
            <div class="col-lg-12 text-center">
                @if ($title = $shortcode->title)
                    <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s">{{ $title }}</h2>
                @endif
                            ...
                            <div class="card-image-plan">
                                ...
                                <div class="info-plan">
                                    ...
                                    @if($description = $package->description)
                                        <p class="font-md color-grey-400">{{ $description }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="box-day-trial box-price">
                                @if($package->price)
                                    <div class="month_price">
                                        ...
                                        <span class="font-md color-grey-500 text-type-enterprise">-{{ $package->duration }}</span><br />
                                    </div>
                                @endif
