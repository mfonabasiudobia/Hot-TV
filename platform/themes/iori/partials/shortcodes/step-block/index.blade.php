            ...
            <div class="col-lg-4 mb-40">
                <div class="box-core-value pl-0">
                    @if ($title = $shortcode->title)
                        <h1 class="color-brand-1 mb-15 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> {{ $title }}</h1>
                    @endif

                    @if ($shortcode->subtitle)
                        <p class="font-md color-grey-400 wow animate__animated animate__fadeIn" data-wow-delay=".2s">{{ $shortcode->subtitle }}</p>
                    @endif
