        ...
        <div class="row mt-50 align-items-center">
            <div class="col-xl-5 col-lg-12 mb-40">
                @if ($title = $shortcode->title)
                    <h2 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeIn" data-wow-delay=".0s">{{ $title }}</h2>
                @endif

                @if ($description = $shortcode->description)
                    <div class="row">
                        <div class="col-lg-10 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                            <p class="font-md color-grey-500">{{ $shortcode->description }}</p>
                        </div>
                    </div>
                @endif
