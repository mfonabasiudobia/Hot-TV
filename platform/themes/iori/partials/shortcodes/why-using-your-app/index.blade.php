            ...
            <div class="col-lg-6 mb-30">
                <div class="box-our-app">
                    ...
                    @if ($title = $shortcode->title)
                        <h3 class="color-brand-1 mb-20 mt-15 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">{{ $title }}</h3>
                    @endif

                    @if ($description = $shortcode->description)
                        <p class="font-sm color-grey-500 mb-40 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            {{ $description }}
                        </p>
                    @endif
