            ...
            <div class="col-xl-6">
                <div class="box-banner-right-home6">
                    @if ($subtitle = $shortcode->subtitle)
                        <span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".s">{{ $subtitle }}</span>
                    @endif

                    @if ($title = $shortcode->title)
                        <h1 class="color-brand-1 mb-20 mt-5 wow animate__animated animate__fadeIn" data-wow-delay=".1s">{{ $title }}</h1>
                    @endif
