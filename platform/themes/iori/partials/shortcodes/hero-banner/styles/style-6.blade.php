            ...
            <div class="row align-items-end">
                <div class="col-lg-6 mb-20">
                    @if ($subtitle = $shortcode->subtitle)
                        <span class="title-line color-brand-2 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">{{ $subtitle }}</span>
                    @endif
                                        ...
                                        <div class="card-small card-small-2">
                                            @if ($tab['image'])
                                                <div class="card-image">
                                                    @if($tab['url'])
                                                        <a href="{{ $tab['url'] }}">
                                                            <div class="box-image"><img src="{{ RvMedia::getImageUrl($tab['image']) }}" alt="{{ $tab['title'] }}"></div>
                                                        </a>
                                                    @else
                                                        <div class="box-image"><img src="{{ RvMedia::getImageUrl($tab['image']) }}" alt="{{ $tab['title'] }}"></div>
                                                    @endif
