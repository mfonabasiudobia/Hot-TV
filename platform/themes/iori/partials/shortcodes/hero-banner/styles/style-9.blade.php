            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-30">
                    ...
                    @if ($title = $shortcode->title)
                        <h2 class="color-brand-1 mb-15 mt-0 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">{{ $title }} </h2>
                    @endif

                    @if ($description = $shortcode->description)
                        <p class="font-md color-grey-500 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">{{ $description }}</p>
                    @endif
