    ...
    <div class="container">
        <div class="text-center">
            @if ($subtitle = $shortcode->subtitle)
                <span class="font-xl-bold color-white text-uppercase wow animate__animated animate__fadeInUp" data-wow-delay=".0s">{{ $subtitle }}</span>
            @endif

            @if ($title = $shortcode->title)
                <h2 class="color-brand-2 mb-60 mt-15 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">{{ $title }}</h2>
            @endif
        </div>
