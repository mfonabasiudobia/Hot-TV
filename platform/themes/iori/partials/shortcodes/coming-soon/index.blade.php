        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-40">
                ...
                @if ($title = $shortcode->title)
                    <h1 class="color-brand-1 mt-15 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">{{ $title }}</h1>
                @endif
                ...
                @if ($description = $shortcode->description)
                    <p class="font-md color-grey-500 wow animate__animated animate__fadeIn" data-wow-delay=".0s">{{ $description }}</p>
                @endif
