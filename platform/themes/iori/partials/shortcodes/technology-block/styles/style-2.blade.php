    ...
    <div class="container">
        <div class="text-center">
            @if ($title = $shortcode->title)
                <h2 class="color-brand-1 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">{{ $title }}</h2>
            @endif

            @if($description = $shortcode->description)
                <p class="color-grey-500 font-md wow animate__animated animate__fadeIn" data-wow-delay=".2s">{{ $description }}</p>
            @endif
        </div>
