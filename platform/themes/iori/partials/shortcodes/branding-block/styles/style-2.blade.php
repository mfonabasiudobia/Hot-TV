        ...
        <div class="row align-items-center">
            <div class="col-lg-5 mb-30">
                @if ($subtitle = $shortcode->subtitle)
                    <span class="title-line line-48 wow animate__animated animate__fadeInUp">{{ $subtitle }}</span>
                @endif

                @if ($title = $shortcode->title)
                    <h2 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeInUp">{{ $title }}</h2>
                @endif
