    ...
    <div class="container">
        @if($image = $career->getMetaData('image', true))
            <div class="box-image-detail">
                <img class="bd-rd16 d-block" src="{{ RvMedia::getImageUrl($image) }}" alt="{{ $career->name }}">
            </div>
        @endif
                    ...
                    <div class="box-detail-content">
                        <div class="row align-items-center">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-12 mb-30">
                                ...
                                <span class="time-read font-xs color-grey-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon-16">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-12 text-start text-md-end mb-30">
                                <a class="btn btn-brand-1 btn-apply" href="{{ $career->getMetaData('apply_url', true) }}">
                        ...
                        <div class="box-info-bottom">
                            <div class="row align-items-center">
                                ...
                                @if($tags->isNotEmpty())
                                    <div class="d-flex gap-2 justify-content-end col-lg-6 col-md-6 col-sm-7 col-12 text-start text-sm-end mb-30">
                                        @foreach($tags as $tag)
    ...
    <div class="container">
        ...
        <div class="row mt-50">
            @foreach($relatedCareers as $career)
                <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".{!! $loop->index !!}s">
                    <div class="card-offer hover-up">
                        <div class="card-image">
                            <img src="{{ RvMedia::getImageUrl($career->getMetaData('icon', true)) }}" alt="{{ $career->name }}">
                        </div>
                        <div class="card-info">
                            ...
                            <div class="box-button-offer">
                                <a href="{{ $career->url }}" class="btn btn-default font-sm-bold pl-0 color-brand-1">
                                    {{ __('Learn More') }}
