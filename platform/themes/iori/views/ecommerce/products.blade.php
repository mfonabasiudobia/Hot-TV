    ...
    <div class="container product-area">
        <div class="row align-items-start align-items-md-center">
            <div class="col-lg-3 col-md-2 col-sm-3 col-3 pe-0">
                <a @class(['filter-layout filter-link btn-grid', 'active' => $layout === 'grid']) data-layout="grid" href="#">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_222_15978)">
                            <path d="M5 0H1C0.448 0 0 0.448 0 1V5C0 5.552 0.448 6 1 6H5C5.552 6 6 5.552 6 5V1C6 0.448 5.552 0 5 0Z" fill="currentColor"/>
                            <path d="M5 9H1C0.448 9 0 9.448 0 10V14C0 14.552 0.448 15 1 15H5C5.552 15 6 14.552 6 14V10C6 9.448 5.552 9 5 9Z" fill="currentColor"/>
                            <path d="M5 18H1C0.448 18 0 18.448 0 19V23C0 23.552 0.448 24 1 24H5C5.552 24 6 23.552 6 23V19C6 18.448 5.552 18 5 18Z" fill="currentColor"/>
                            <path d="M14 0H10C9.448 0 9 0.448 9 1V5C9 5.552 9.448 6 10 6H14C14.552 6 15 5.552 15 5V1C15 0.448 14.552 0 14 0Z" fill="currentColor"/>
                            <path d="M14 9H10C9.448 9 9 9.448 9 10V14C9 14.552 9.448 15 10 15H14C14.552 15 15 14.552 15 14V10C15 9.448 14.552 9 14 9Z" fill="currentColor"/>
                            <path d="M14 18H10C9.448 18 9 18.448 9 19V23C9 23.552 9.448 24 10 24H14C14.552 24 15 23.552 15 23V19C15 18.448 14.552 18 14 18Z" fill="currentColor"/>
                            <path d="M23 0H19C18.448 0 18 0.448 18 1V5C18 5.552 18.448 6 19 6H23C23.552 6 24 5.552 24 5V1C24 0.448 23.552 0 23 0Z" fill="currentColor"/>
                            <path d="M23 9H19C18.448 9 18 9.448 18 10V14C18 14.552 18.448 15 19 15H23C23.552 15 24 14.552 24 14V10C24 9.448 23.552 9 23 9Z" fill="currentColor"/>
                            <path d="M23 18H19C18.448 18 18 18.448 18 19V23C18 23.552 18.448 24 19 24H23C23.552 24 24 23.552 24 23V19C24 18.448 23.552 18 23 18Z" fill="currentColor"/>
                        </g>
                        <defs>
                ...
                <a @class(['filter-layout filter-link btn-list', 'active' => $layout === 'list']) data-layout="list" href="#">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_222_15988)">
                            ...
                            <path d="M23.625 20.25H1.125C0.826631 20.25 0.540483 20.4475 0.329505 20.7992C0.118526 21.1508 0 21.6277 0 22.125C0 22.6223 0.118526 23.0992 0.329505 23.4508C0.540483 23.8025 0.826631 24 1.125 24H23.625C23.9234 24 24.2095 23.8025 24.4205 23.4508C24.6315 23.0992 24.75 22.6223 24.75 22.125C24.75 21.6277 24.6315 21.1508 24.4205 20.7992C24.2095 20.4475 23.9234 20.25 23.625 20.25Z" fill="currentColor"/>
                        </g>
                        <defs>
                ...
                <div class="d-inline-block">
                    <div class="d-flex align-items-center box-filter-text">
                        ...
                        <div class="box-sortby d-flex align-items-center">
                           ...
                           <div>
                               <select class="form-select form-select-soft-by" name="sort-by" aria-label="">
        ...
        <div class="row">
            @if ($enableSidebar = theme_option('enable_sidebar_products', true))
                <div class="col-lg-3 order-lg-1 order-2">
                    {!! Theme::partial('ecommerce.product.filters') !!}
            ...
            @endif
            <div @class(['order-lg-1 order-1', 'col-lg-9' => $enableSidebar, 'col-lg-12' => ! $enableSidebar])>
