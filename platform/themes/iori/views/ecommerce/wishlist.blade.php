                        ...
                        <tbody>
                            ...
                            <tr class="cart-form__cart-item cart_item">
                                    ...
                                    <td class="product-subtotal product-md d-md-table-cell d-block" data-title="Total">
                                        <form class="cart-form" action="{{ route('public.cart.add-to-cart') }}" method="POST">
                                            ...
                                            <div class="button-add">
                                                <button type="submit" class="btn @if ($product->isOutOfStock()) disabled @endif"
                                                        @if ($product->isOutOfStock()) disabled @endif>{{ __('Add') }}
                                                </button>
                                            </div>
                                        </form>
                                    </td>
                                ...
                                <td class="product-remove">
                                    <a class="fs-4 remove remove-wishlist-item" href="{{ route('public.wishlist.remove', $product->id) }}"
