                        ...
                        <table class="table table-bordered table-striped" cellpadding="0" cellspacing="0" role="grid">
                            <thead>
                                <tr role="row" style="height: 0px;">
                                    <th rowspan="1" colspan="1" style="padding-top: 0; padding-bottom: 0; border-top-width: 0; border-bottom-width: 0; height: 0; width: 0;"></th>
                                    @foreach($products as $product)
                                        <td rowspan="1" colspan="1" style="padding-top: 0; padding-bottom: 0; border-top-width: 0; border-bottom-width: 0; height: 0; width: 0;"></td>
                                    @endforeach
                                </tr>
                            </thead>
                            <tbody class="border-top-0">
                                ...
                                <tr>
                                    ...
                                    @foreach($products as $product)
                                        <td>
                                            <a class="fs-4 remove remove-compare-item" href="{{ route('public.compare.remove', $product->id) }}"
