    ...
    <div class="container product-area">
        <div class="row align-items-start align-items-md-center">
            <div class="col-lg-3 col-md-2 col-sm-3 col-3 pe-0">
                <a @class(['filter-layout filter-link btn-grid', 'active' => request()->input('layout') === 'grid']) data-layout="grid" href="#"> </a>
                <a @class(['filter-layout filter-link btn-list', 'active' => request()->input('layout') === 'list']) data-layout="list" href="#"> </a></div>
