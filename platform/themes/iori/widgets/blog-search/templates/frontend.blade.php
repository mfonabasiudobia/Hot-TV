    ...
    <div class="card">
        ...
        <div class="card-content p-4">
            <form class="input-group rounded" action="{{ route('public.search') }}" method="get">
                <input type="search" class="form-control rounded-start" value="{{ BaseHelper::stringify(request()->query('q')) }}" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
