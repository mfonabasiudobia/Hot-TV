...
<body>
    <main class="container">
        <section class="text-center">
            ...
            <p>You've placed an order from {{ cache('setting')->business_name }}</p>
        </section>
            ...
            <section style="text-align: left;">
                <table class="table" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <tr class="text-sm">
                            <td colspan="2" style="font-weight: bold; padding: 2px 0; text-align: right">Service Fee:</td>
                            <td class="font-light">+&#8358;{{ $order->service_fee }}</td>
                        </tr>
                        <tr class="text-sm">
                            <td colspan="2" style="font-weight: bold; padding: 2px 0; text-align: right">Delivery Fee:</td>
                            <td class="font-light">+&#8358;{{ $order->delivery_fee }}</td>
                        </tr>
                        <tr class="text-sm">
                            <td colspan="2" style="font-weight: bold; padding: 2px 0; text-align: right">Driver Tip:</td>
