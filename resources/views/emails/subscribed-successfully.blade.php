    ...
    <body>
        <main class="container">
            ...
            <section style="border-radius: 5px;background-color: #fff; padding: 20px; color: #5E5E5E; overflow: hidden;">
                ...
                <div class="mb-5">
                    We’re excited to welcome you to {{ config('app.name') }}! Your subscription to the {{ $user->subscription->subscription->name }} plan is now active.
...
{{--                        <li><bold>Start Date:</bold> [Subscription Start Date]</li>--}}
{{--                        <li><bold>Renewal Date:</bold> [Next Billing Date]</li>--}}
                        <li><bold>Amount:</bold> {{ $user->subscription->amount }} on {{ $user->subscription->subscription->plan->name }} basis</li>
                    </ul>
                </div>

                <div>You can access your account and manage your subscription at any time by logging into your account.</div>
                <div class="mb-5">
                    Thank you for choosing {{ config('app.name') }}. We're here to help if you have any questions or need assistance.
                </div>
