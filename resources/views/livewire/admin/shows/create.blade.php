            ...
            <form class="space-y-5" wire:submit.prevent='submit'>
                ...
                <div class="space-y-5 content-wrapper">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control-light" placeholder="Meta Title" wire:model.defer="meta_title" />
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control-light" placeholder="Meta Description" wire:model.defer="meta_description"></textarea>
