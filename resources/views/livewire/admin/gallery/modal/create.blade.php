...
{{--                                    :class="images.some(e => e.id == {{$file->id}}) ? 'border-brown-100' : ''"--}}
                ...
                >
                    ...
                    <div class="border border-dashed min-h-[40vh] text-white border-secondary outline-secondary rounded-lg overflow-hidden outline-1  p-2 outline-dashed outline-offset-4 flex flex-col items-center justify-center relative">
                       @if($uploadedFile)
