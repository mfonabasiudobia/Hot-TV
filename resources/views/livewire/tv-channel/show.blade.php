    ...
    <div class="container">
        ...
        <section>
            <section class="w-full max-h-screen relative">
                <video id="player" controls autoplay loop playsinline style="width: 100%;" class="max-h-screen" src="{{ file_path($tvChannel->recorded_video) }}"></video>
            ...
            <div class="space-y-7">
                ...
                <section class="space-y-5" id="description">{!! $tvChannel->description !!}</section>
            </div>
        </section>
    </div>
</div>
