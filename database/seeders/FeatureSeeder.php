...
class FeatureSeeder extends Seeder
{
    public function run(): void
    {
        $features = [
            ...
            [ "name" => FeatureEnum::OPTION_TO_ADD_1_EXTRA_MEMBERS->value, "description" => "Option to add 1 extra member who does'nt live with you"],
            [ "name" => FeatureEnum::OPTION_TO_ADD_2_EXTRA_MEMBERS->value, "description" => "Option to add 2 extra member who does'nt live with you"],
