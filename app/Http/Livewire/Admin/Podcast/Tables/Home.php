...
namespace App\Http\Livewire\Admin\Podcast\Tables;
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('title')
            ->addColumn('created_at_formatted', function(Podcast $model){
                return $model->createdAt();
            })
            ->addColumn('status_formatted', function(Podcast $model){
    ...
    public function actions(): array
    {
       return [
           ...
           Button::add('edit')
                ...
                ->class('bg-gray-600 cursor-pointer text-white px-3 py-1 m-1 rounded text-sm')
                ->target('_self')
                ->route('admin.podcast.edit', ['id' => 'id']),
