...
namespace App\Http\Livewire\Admin\Season\Tables;
...
final class Home extends PowerGridComponent
{
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Season>
     */
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('status_formatted', function(Season $model){
    ...
    public function actions(): array
    {
       return [
           ...
           Button::add('edit')
                ...
                ->target('_self')
                ->route('admin.tv-show.season.edit', [ 'id' => 'id' ]),
